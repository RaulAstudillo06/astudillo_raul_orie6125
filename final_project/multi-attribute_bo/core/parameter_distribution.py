...
class ParameterDistribution(object):
    ...
    We admit two possible ways to specify a parameter distribution: (a) through its support (has to be finite)
    and probability distribution; (b) through a sample generator
    """
