...
class MultiObjective(Objective):
    ...
    :param noise_var: list of noise variances for each objective; this allows to output corrupted evaluations.
    ...
    def evaluate_w_noise(self, x):
        """
        Returns the evaluation of the objectives at x corrupted with Gaussian noise.
        """
